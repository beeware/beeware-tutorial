...
latex_documents = [
    ("index", "beeware.tex", "BeeWare Documentation", "Russell Keith-Magee", "manual"),
]
...
man_pages = [("index", "beeware", "BeeWare Documentation", ["Russell Keith-Magee"], 1)]
